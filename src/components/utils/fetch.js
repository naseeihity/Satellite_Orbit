...
import { station, satellite, stationStatus, statistic, smart, curInfo, commond, getImg } from './api';
...
export const postImg = data => axios.post(getImg, JSON.stringify(Object.assign({}, page, data))).then(res => res.data);
